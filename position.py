...
def analyze_and_save():
    ...
    # input files
    pos_csv_path = constants.file_paths["POS_CSV"]
    age_csv_path = constants.file_paths["AGE_CSV"]  # generated by python

    # output file
    result_csv_path = constants.file_paths["AGEGROUP_POS_CSV"]
    ...
    print("Stats for age groups generated successfully. \nSee:",
          result_csv_path, "\nTime elapsed:",
          time.time() - start, "\n===")
